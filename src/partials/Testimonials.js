      ...
      <div className="max-w-6xl mx-auto px-4 sm:px-6">
        <div className="py-12 md:py-20">
          <img
            ...
            src={require("../images/Puce_bleu_ciel.png").default}
            width="80"
            height="80"
            alt="Hero"
            data-aos="zoom-y-out"
          />
          {/* Section header */}
          <div className="max-w-3xl mx-auto text-center pb-12 md:p-1">
            <h2 className="h2 mb-4">Comment devenir franchisé?</h2>
